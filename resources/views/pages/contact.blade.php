...
<section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          <h1 class="text-white font-weight-bold">Nous contacter</h1>
          <div class="custom-breadcrumbs">
            <span class="text-white"><strong>Vous avez un avis, une suggestion ou toute autre préoccupation ? Ecrivez nous ici</strong></span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <form method="POST" action="{{route('contact.post')}}">
            @csrf
                @if (session()->has('msg-envoye'))
                    <div class="row" id="msg-envoye">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="message" name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Ecrivez votre message ici..." required></textarea>
              </div>
            </div>
