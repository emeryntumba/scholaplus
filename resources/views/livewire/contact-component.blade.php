        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          <form wire:submit.prevent="submit">
                ...
                @if (session()->has('message'))
                    <div class="row">
                        <div class="col-md-12 alert alert-danger alert alert-success">
                            {{ session('message') }}
                        </div>
                    </div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea wire:model.defer="message" name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Ecrivez votre message ici..." required></textarea>
              </div>
            </div>
